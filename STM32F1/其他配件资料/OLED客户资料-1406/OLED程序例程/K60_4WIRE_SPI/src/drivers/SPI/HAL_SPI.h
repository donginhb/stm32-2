...
#define SPI_OLED_CS_LOW()       GPIO_SET(PORTC,8,0)  
/* Deselect SPI FLASH: Chip Select pin high */
#define SPI_OLED_CS_HIGH()      GPIO_SET(PORTC,8,1)  


/* Select SPI FLASH: Chip Select pin low  */
#define SPI_OLED_RST_LOW()       GPIO_SET(PORTC,9,0)  
/* Deselect SPI FLASH: Chip Select pin high */
#define SPI_OLED_RST_HIGH()      GPIO_SET(PORTC,9,1)  

/* Select SPI FLASH: Chip Select pin low  */
#define SPI_OLED_CD_LOW()       GPIO_SET(PORTC,10,0)  
/* Deselect SPI FLASH: Chip Select pin high */
#define SPI_OLED_CD_HIGH()      GPIO_SET(PORTC,10,1)  
...
//SPI初始化函数
uint8 SPI_Init(SPIx ,uint8 ,uint8 );
//SPI主机读写函数
uint8 SPI_Master_WriteRead(SPIx ,uint8 ,uint8 ,uint8);
//SPI主机读函数
uint8 SPI_Master_Read(SPIx);
//SPI主机写函数
void SPI_Master_Write(SPIx ,uint8 ,uint8 ,uint8);
