...
#line 68 ".\\usb_library\\inc\\usb_type.h"
...
void Set_System(void)
{
  ...
  if(HSEStartUpStatus == SUCCESS)
  {
    ...
    RCC_ADCCLKConfig(((u32)0x00008000));
  ...
  RCC_APB2PeriphClockCmd(((u32)0x00000020) | ((u32)0x00000040)| ((u32)0x00000010), ENABLE);
  ...
  GPIO_InitStructure.GPIO_Pin = ((u16)0x0200) | ((u16)0x0800) ;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
  GPIO_Init(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1800)), &GPIO_InitStructure);

   
  GPIO_InitStructure.GPIO_Pin = ((u16)0x0100) | ((u16)0x0400);
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
  GPIO_Init(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1800)), &GPIO_InitStructure);
     
  GPIO_InitStructure.GPIO_Pin = ((u16)0x0080)|((u16)0x1000);
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
...
void Set_USBClock(void)
{
  ...
  RCC_APB1PeriphClockCmd(((u32)0x00800000), ENABLE);
}
...
void USB_Interrupts_Config(void)
{
  ...
  NVIC_PriorityGroupConfig(((u32)0x700));
...
{ 
  if (NewState != DISABLE)
  {
    GPIO_ResetBits(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x2000));
  }
  else
  {
    GPIO_SetBits(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x2000));
  }
}
...
u8 JoyState(void)
{
  ...
  if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1800)), ((u16)0x0400)))
  {
    return 3;
  }
   
  if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1800)), ((u16)0x0100)))
  {
    return 2;
  }
   
  if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1800)), ((u16)0x0200)))
  {
    return 4;
  }
   
  if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1800)), ((u16)0x0800)))
  {
    return 1;
  }
  if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)), ((u16)0x0080)))
  {
    return 5;
  }
   if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)), ((u16)0x1000)))
  {
    return 6;
  }
...
void Joystick_Send(u8 Keys)
{
  ...
  UserToPMABufferCopy(Mouse_Buffer, GetEPTxAddr(((u8)1)), 4);
  if(Mouse_Buffer[0]!= 0)
  {
    Mouse_Buffer[0] = 0;
    UserToPMABufferCopy(Mouse_Buffer, GetEPTxAddr(((u8)1)), 4);
