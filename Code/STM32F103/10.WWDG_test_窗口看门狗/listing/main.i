...
int main(void)
{
  ...
  if(RCC_GetFlagStatus(((u8)0x7E)) != RESET)
  {	 
     
    GPIO_WriteBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x0400), Bit_SET);
  ...
  {	 
    ...
    GPIO_WriteBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x0400), Bit_RESET);
  }
  ...
  RCC_APB1PeriphClockCmd(((u32)0x00000800), ENABLE);

   
  WWDG_SetPrescaler(((u32)0x00000180));
...
void RCC_Configuration(void)
{
  ...
  if(HSEStartUpStatus == SUCCESS)
  {
    ...
    RCC_PCLK1Config(((u32)0x00000000));

     
    FLASH_SetLatency(((u32)0x00000000));
  ...
  RCC_APB2PeriphClockCmd(((u32)0x00000010) | ((u32)0x00000008) |	 ((u32)0x00000020) |
                         ((u32)0x00000001), ENABLE);  
}
...
void NVIC_Configuration(void)
{
  ...
  NVIC_PriorityGroupConfig(((u32)0x500));
  ...
  NVIC_InitStructure.NVIC_IRQChannel = ((u8)0x00);
