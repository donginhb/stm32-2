...
void RCC_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC | RCC_APB2Periph_GPIOD |RCC_APB2Periph_AFIO| RCC_APB2Periph_USART1 | RCC_APB2Periph_GPIOA, ENABLE);
...
void GPIO_Configuration(void)
{
  ...
  /* Configure PD.10, PD.11, PD.12 and PD.12 as Output push-pull */
