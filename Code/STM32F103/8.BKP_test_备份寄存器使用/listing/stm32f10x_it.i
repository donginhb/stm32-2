...
void TAMPER_IRQHandler(void)
{
  ...
  {  
    ...
    { 
      ...
      GPIO_WriteBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x1000), Bit_SET);
	  printf("\nLed_3: on.--------------------DRx have been reset.");
    }
    else
    { 
       
      GPIO_WriteBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x2000), Bit_SET);
