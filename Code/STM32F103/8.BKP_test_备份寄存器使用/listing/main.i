...
int main(void)
{
  ...
  BKP_TamperPinLevelConfig(((u16)0x0001));
  ...
  if(CheckBackupReg(0xA53C) == 0x00)
  {
    ...
    GPIO_Write(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x0400));
	printf("Led_1: on.--------------------The datas are as their initial status\r\n");
  }
  else
  {
     
    GPIO_Write(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x0800));
...
void RCC_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(((u32)0x00000010) | ((u32)0x00000020) |((u32)0x00000001)| ((u32)0x00004000) | ((u32)0x00000004), ENABLE);
...
void GPIO_Configuration(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = ((u16)0x0400) | ((u16)0x0800) | ((u16)0x1000) | ((u16)0x2000);
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
...
void NVIC_Configuration(void)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannel = ((u8)0x02);
...
void WriteToBackupReg(u16 FirstBackupData)
{
  BKP_WriteBackupRegister(((u16)0x0004), FirstBackupData);
  BKP_WriteBackupRegister(((u16)0x0008), ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR1 + 0x5A);
  BKP_WriteBackupRegister(((u16)0x000C), ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR2 + 0x3C);
  BKP_WriteBackupRegister(((u16)0x0010), ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR3 + 0xA5);
  BKP_WriteBackupRegister(((u16)0x0014), ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR4 + 0x06);
  BKP_WriteBackupRegister(((u16)0x0018), ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR5 + 0x78);
  BKP_WriteBackupRegister(((u16)0x001C), ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR6 + 0xFF);
  BKP_WriteBackupRegister(((u16)0x0020), ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR7 + 0xB4);
  BKP_WriteBackupRegister(((u16)0x0024), ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR8 + 0x1E);
  BKP_WriteBackupRegister(((u16)0x0028), ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR9 + 0xD4);
}
...
u8 CheckBackupReg(u16 FirstBackupData)
{
  if(BKP_ReadBackupRegister(((u16)0x0004)) != FirstBackupData) return 1;
  if(BKP_ReadBackupRegister(((u16)0x0008)) != (((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR1 + 0x5A)) return 2;
  if(BKP_ReadBackupRegister(((u16)0x000C)) != (((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR2 + 0x3C)) return 3;
  if(BKP_ReadBackupRegister(((u16)0x0010)) != (((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR3 + 0xA5)) return 4;
  if(BKP_ReadBackupRegister(((u16)0x0014)) != (((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR4 + 0x06)) return 5;
  if(BKP_ReadBackupRegister(((u16)0x0018)) != (((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR5 + 0x78)) return 6;
  if(BKP_ReadBackupRegister(((u16)0x001C)) != (((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR6 + 0xFF)) return 7;
  if(BKP_ReadBackupRegister(((u16)0x0020)) != (((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR7 + 0xB4)) return 8;
  if(BKP_ReadBackupRegister(((u16)0x0024)) != (((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR8 + 0x1E)) return 9;
  if(BKP_ReadBackupRegister(((u16)0x0028)) != (((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->DR9 + 0xD4)) return 10;
...
{
  if(BKP_ReadBackupRegister(((u16)0x0004)) != 0x0000) return 1;
  if(BKP_ReadBackupRegister(((u16)0x0008)) != 0x0000) return 2;
  if(BKP_ReadBackupRegister(((u16)0x000C)) != 0x0000) return 3;
  if(BKP_ReadBackupRegister(((u16)0x0010)) != 0x0000) return 4;
  if(BKP_ReadBackupRegister(((u16)0x0014)) != 0x0000) return 5;
  if(BKP_ReadBackupRegister(((u16)0x0018)) != 0x0000) return 6;
  if(BKP_ReadBackupRegister(((u16)0x001C)) != 0x0000) return 7;
  if(BKP_ReadBackupRegister(((u16)0x0020)) != 0x0000) return 8;
  if(BKP_ReadBackupRegister(((u16)0x0024)) != 0x0000) return 9;
  if(BKP_ReadBackupRegister(((u16)0x0028)) != 0x0000) return 10;
...
void PrintBackupReg(void)
{
  ...
  printf("DR1  = 0x%04X\t",BKP_ReadBackupRegister(((u16)0x0004))); 
  printf("DR2  = 0x%04X\t",BKP_ReadBackupRegister(((u16)0x0008)));
  printf("DR3  = 0x%04X\t",BKP_ReadBackupRegister(((u16)0x000C)));
  printf("DR4  = 0x%04X\t",BKP_ReadBackupRegister(((u16)0x0010)));
  printf("DR5  = 0x%04X\t\n",BKP_ReadBackupRegister(((u16)0x0014)));
  printf("DR6  = 0x%04X\t",BKP_ReadBackupRegister(((u16)0x0018)));
  printf("DR7  = 0x%04X\t",BKP_ReadBackupRegister(((u16)0x001C)));
  printf("DR8  = 0x%04X\t",BKP_ReadBackupRegister(((u16)0x0020)));
  printf("DR9  = 0x%04X\t",BKP_ReadBackupRegister(((u16)0x0024)));
  printf("DR10 = 0x%04X\t\n",BKP_ReadBackupRegister(((u16)0x0028)));
}
