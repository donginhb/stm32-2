...
int main(void)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannel = ((u8)0x17);
  ...
  NVIC_SystemHandlerPriorityConfig(((u32)0x02C39A), !PreemptionPriorityValue, 0);
  
  while (1)
  {
    if(PreemptionOccured != FALSE)
    {
      GPIO_WriteBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x0400), (BitAction)(1 - GPIO_ReadOutputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x0400))));
      Delay(0x5FFFF);
      GPIO_WriteBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x0800), (BitAction)(1 - GPIO_ReadOutputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x0800))));
      Delay(0x5FFFF);
      GPIO_WriteBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x1000), (BitAction)(1 - GPIO_ReadOutputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x1000))));
      Delay(0x5FFFF);
      GPIO_WriteBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x2000), (BitAction)(1 - GPIO_ReadOutputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)), ((u16)0x2000))));
      Delay(0x5FFFF); 
    }
...
void RCC_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(((u32)0x00000004) | ((u32)0x00000008) | 
                         ((u32)0x00000010) |((u32)0x00000020) |
						 ((u32)0x00000040) | ((u32)0x00000001), ENABLE);
}
...
void GPIO_Configuration(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = ((u16)0x2000)|((u16)0x0100);
...
void EXTI_Configuration(void)
{
  ...
  GPIO_EXTILineConfig(((u8)0x02), ((u8)0x08));

       
  EXTI_InitStructure.EXTI_Line = ((u32)0x00100);
  EXTI_Init(&EXTI_InitStructure);
}
