...
int main(void)
{
  ...
  {	/* IWDGRST flag set */
    /* Turn on led connected to PD.10 */
  ...
  {	/* IWDGRST flag is not set */
    /* Turn off led connected to PD.10 */
...
void RCC_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC | RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOD |
...
void GPIO_Configuration(void)
{
  ...
  /* Configure PD.10 and PD.11 as Output push-pull */
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10 | GPIO_Pin_11;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
  GPIO_Init(GPIOD, &GPIO_InitStructure);

  /* Configure PB8 as input floating (EXTI Line9) */
