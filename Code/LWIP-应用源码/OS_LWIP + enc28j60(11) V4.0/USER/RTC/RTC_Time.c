...
void Time_Regulate(void)
{
  ...
  printf("Please Set Months between 1 to 12\r\n");
  ...
  printf("Please Set Days between 1 to 31\r\n");
  ...
  printf("Please Set Hours between 1 to 23\r\n");
  ...
  printf("Please Set Minutes between 1 to 59\r\n");
  ...
  printf("Please Set Seconds between 1 to 59\r\n");
