...
void USB_Send_Data(u8* data_buffer , int nLen )
{
  ...
  if( count_in >64 )
  	count_in = 64;
  //uStatus = GetENDPOINT(ENDP1);
  //SetENDPOINT( ENDP1 , uStatus & ~EP_CTR_TX	);
  ...
  //{
  //	 uStatus = GetENDPOINT(ENDP1);
//	 if( uStatus & EP_CTR_TX )
//	 	break;
 // }
  while( count_in!=0 && uStatus < 60000 )
  {
     uStatus++;	
	 //nop;
   }
