...
char TestSD_ReadWriteFunction( void )
{   unsigned int G_Debug_Temp;
     unsigned char G_Debug_Buff[ 512 ];     

memset( &G_Debug_Buff[0],0x55, 512 );
SD_WriteSingleBlock( 1, &G_Debug_Buff[0] );

memset( &G_Debug_Buff[0],0xAA, 256 );
SD_ReadSingleBlock( 1, &G_Debug_Buff[0] );

if( memcmp( &G_Debug_Buff[0] , &G_Debug_Buff[ 256 ] , 256) == 0 ) {
...
* Return         : None
*******************************************************************************/
static void Init_SD_PWR_IO( void )
{
...
GPIO_ResetBits(GPIOC,GPIO_Pin_8);	//打开SD卡	给SD供电
