...
#define OS_TASK_STAT_STK_SIZE   128    /* 统计任务堆栈大小 */
#define OS_TASK_IDLE_STK_SIZE   128    /* 空闲任务堆栈大小 */


                                       /* --------------------- TASK MANAGEMENT ---------------------- */
#define OS_TASK_CHANGE_PRIO_EN    1    /*     是否使用修改优先级别功能                      */
#define OS_TASK_CREATE_EN         1    /*     是否使用任务创建功能                         */
